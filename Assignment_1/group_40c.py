...
toolbox.register("mutate", tools.mutFlipBit, indpb=0.3)            #changed to flip the value of the attributes of the input individual and return the mutant.
toolbox.register("select", tools.selRoulette)                      #changed to select k individuals from the input individuals using k spins of a roulette.
